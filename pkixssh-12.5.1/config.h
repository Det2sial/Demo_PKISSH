...
/* Define as const if ASN1_STRING_CONST() declare const argument */
#define ASN1_STRING_LENGTH_CONST const
...
/* Define if restarted signals do not interrupt select */
...
/* Define to 1 if snprintf is broken or outdated (lack %zu, %ld and etc.) */
...
/* Define to 1 if tcgetattr with ICANON may hang */
...
/* Define to 1 if compiler accept __attribute__ that warn if last parameter is
   not NULL */
...
/* Define to 1 if you have the `BN_check_prime' function. */
/* #undef HAVE_BN_CHECK_PRIME */

/* Define to 1 if you have the `BN_is_negative' function. */
#define HAVE_BN_IS_NEGATIVE 1
...
/* Define to 1 if your system function calloc(0, x) returns non-null, and to 0
   otherwise. */
...
/* Define to 1 if you have the declaration of `arc4random_stir', and to 0 if
   you don't. */
#define HAVE_DECL_ARC4RANDOM_STIR 0
...
/* Define to 1 if you have the declaration of `DEFINE_STACK_OF', and to 0 if
   you don't. */
#define HAVE_DECL_DEFINE_STACK_OF 1
...
/* Define to 1 if you have the declaration of `pututline', and to 0 if you
   don't. */
#define HAVE_DECL_PUTUTLINE 1
...
/* Define to 1 if you have the declaration of `UTF8_getc', and to 0 if you
   don't. */
#define HAVE_DECL_UTF8_GETC 1
...
/* Define to 1 if you have the `DSA_meth_get_verify' function. */
#define HAVE_DSA_METH_GET_VERIFY 1

/* Define to 1 if you have the `DSA_meth_new' function. */
#define HAVE_DSA_METH_NEW 1

/* Define to 1 if you have the `DSA_meth_set_finish' function. */
#define HAVE_DSA_METH_SET_FINISH 1
...
/* Define to 1 if `name' is a member of `ECDSA_METHOD'. */
/* #undef HAVE_ECDSA_METHOD_NAME */

/* Define to 1 if you have the `ECDSA_METHOD_new' function. */
/* #undef HAVE_ECDSA_METHOD_NEW */
...
/* Define to 1 if you have the `ERR_remove_thread_state' function. */
...
/* Define to 1 if you have the `EVP_CIPHER_CTX_encrypting' function. */
#define HAVE_EVP_CIPHER_CTX_ENCRYPTING 1
...
/* Define to 1 if you have the `EVP_CIPHER_meth_new' function. */
#define HAVE_EVP_CIPHER_METH_NEW 1
...
/* Define to 1 if you have the `EVP_MD_flags' function. */
...
/* Define to 1 if you have the <fipscheck.h> header file. */
/* #undef HAVE_FIPSCHECK_H */
...
/* Define to 1 if you have the `OPENSSL_version_major' function. */
/* #undef HAVE_OPENSSL_VERSION_MAJOR */

/* Define if you have Digital Unix Security Integration Architecture */
/* #undef HAVE_OSF_SIA */

/* Define to 1 if you have the `OSSL_STORE_open' function. */
#define HAVE_OSSL_STORE_OPEN 1
...
/* Define to 1 if you have the `RSA_meth_get_pub_enc' function. */
#define HAVE_RSA_METH_GET_PUB_ENC 1
...
/* Define to 1 if you have the `RSA_PKCS1_OpenSSL' function. */
#define HAVE_RSA_PKCS1_OPENSSL 1
...
/* Define to 1 if you have the 'sk_OPENSSL_STRING_new_null' function. */
#define HAVE_SK_OPENSSL_STRING_NEW_NULL 1
...
/* Define to 1 if the system has the type `struct x509_lookup_method_st'. */
/* #undef HAVE_STRUCT_X509_LOOKUP_METHOD_ST */
...
/* Define to 1 if you have the `UTF8_getc' function. */
#define HAVE_UTF8_GETC 1
...
#define HAVE_X509_CRL_GET0_LASTUPDATE 1
...
/* Define to 1 if you have the `X509_LOOKUP_store' function. */
/* #undef HAVE_X509_LOOKUP_STORE */

/* Define to 1 if you have the `X509_OBJECT_get0_X509' function. */
#define HAVE_X509_OBJECT_GET0_X509 1

/* Define to 1 if you have the `X509_OBJECT_new' function. */
#define HAVE_X509_OBJECT_NEW 1

/* Define to 1 if you have the `X509_STORE_CTX_get0_param' function. */
#define HAVE_X509_STORE_CTX_GET0_PARAM 1

/* Define to 1 if you have the `X509_STORE_CTX_get_by_subject' function. */
#define HAVE_X509_STORE_CTX_GET_BY_SUBJECT 1

/* Define to 1 if you have the `X509_STORE_get0_objects' function. */
#define HAVE_X509_STORE_GET0_OBJECTS 1

/* Define to 1 if you have the `X509_STORE_lock' function. */
#define HAVE_X509_STORE_LOCK 1

/* Define to 1 if you have the `X509_STORE_set_verify_cb' function. */
#define HAVE_X509_STORE_SET_VERIFY_CB 1

/* Define to 1 if you have the `X509_VERIFY_PARAM_get_time' function. */
#define HAVE_X509_VERIFY_PARAM_GET_TIME 1
...
/* Define as const if openpty declare const arguments */
...
#define PACKAGE_STRING "PKIX-SSH 12.5.1"
...
/* Define as const if broken snprintf() declare const char *fmt */
...
#define SSHCADIR "/opt/pkix-ssh/etc/ca"
...
/* Define if you want to validate X.509 certificates with OCSP */
...
/* Define as const if store find method uses const criteria */
#define STORE_FIND_CRITERION_CONST /* not const */
...
#define USER_PATH "/opt/pkix-ssh/bin:/usr/bin:/bin:/usr/sbin:/sbin"
...
/* Use OpenSSL STORE functionality */
#define USE_OPENSSL_STORE2 1
...
/* Define to 1 if you have the `statfs' structure */
#define USE_STRUCT_STATFS 1
