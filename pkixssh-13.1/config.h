...
/* Define to 1 if you have the `EC_GROUP_get_field_type' function. */
/* #undef HAVE_EC_GROUP_GET_FIELD_TYPE */
...
/* Define to 1 if you have the `EVP_PKEY_cmp' function. */
#define HAVE_EVP_PKEY_CMP 1

/* Define to 1 if you have the `EVP_PKEY_print_params' function. */
#define HAVE_EVP_PKEY_PRINT_PARAMS 1
...
#define HAVE_X509_GET_EXTENSION_FLAGS 1
...
#define PACKAGE_STRING "PKIX-SSH 13.1"
...
#define USER_PATH "/opt/bin:/usr/bin:/bin:/usr/sbin:/sbin"
